...
function App() {
  ...
  }  // setTodos(todos) krle puro values del hoe jabey which i dont want
  ...
  return (
    <TodoProvider value={{ todos, addTodo, deleteTodo, updatedTodo, toggleComplete }}>
      <div className="  bg-blue-100 bg-opacity-70 min-h-screen py-8 rounded-lg">
        <div className="w-full max-w-2xl mx-auto shadow-xl rounded-lg px-4 py-3 text-white">
          <h1 className="text-black text-2xl font-bold text-center mb-8 mt-2">
            Manage Your Todos
          </h1>
